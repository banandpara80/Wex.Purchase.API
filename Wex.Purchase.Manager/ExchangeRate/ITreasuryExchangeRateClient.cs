...
public interface ITreasuryExchangeRateClient
{
    ...
    /// <param name="transactionDate">The date for which to retrieve the exchange rate.</param>
    /// <param name="cancellationToken">Cancellation token for the async operation.</param>
    /// <returns>The exchange rate as a decimal, or null if not found.</returns>
    Task<decimal?> GetExchangeRateAsync(string currencyCode, DateOnly transactionDate, CancellationToken cancellationToken = default);
        ...
        /// <param name="transactionDate">The date for which to retrieve exchange rates.</param>
        /// <param name="cancellationToken">Cancellation token for the async operation.</param>
        /// <returns>Dictionary mapping currency codes to exchange rates.</returns>
        Task<Dictionary<string, decimal>> GetExchangeRatesAsync(string[] currencyCodes, DateOnly transactionDate, CancellationToken cancellationToken = default);
        ...
        /// <param name="transactionDate">The date for which to retrieve the exchange rate.</param>
        /// <param name="cancellationToken">Cancellation token for the async operation.</param>
        /// <returns>The exchange rate for the specified date, or the most recent available rate.</returns>
        /// <exception cref="InvalidOperationException">Thrown if no exchange rate is found for the currency.</exception>
        Task<decimal> GetExchangeRateWithFallbackAsync(string currencyCode, DateOnly transactionDate, CancellationToken cancellationToken = default);
}
