...
public interface ITreasuryExchangeRateClient
{
    ...
    /// </summary>
    /// <param name="countryCurrencyDesc">Country+Currency</param>
    ...
    Task<decimal?> GetExchangeRateAsync(string countryCurrencyDesc, DateOnly exchangeRateDate, CancellationToken cancellationToken = default);

    /// <summary>
    /// Retrieves exchange rates for multiple currencies on a given date.
    /// </summary>
    /// <param name="countryCurrencyDesc">Array of country-currency codes.</param>
    ...
    Task<Dictionary<string, decimal>> GetExchangeRatesAsync(string[] countryCurrencyDescs, DateOnly exchangeRateDate, CancellationToken cancellationToken = default);
    ...
    Task<ExchangeRateRecord> GetExchangeRateWithFallbackAsync(string countryCurrencyDesc, DateOnly exchangeRateDate, CancellationToken cancellationToken = default);
}
